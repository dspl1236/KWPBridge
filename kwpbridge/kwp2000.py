...
from .constants import (
    ...
    KWP2000_READ_ECU_ID, KWP2000_SECURITY_ACCESS,
    KWP2000_SESSION_DEFAULT, KWP2000_SESSION_EXTENDED,
    ...
    KWP2000_LOCAL_ID_MEAS, KWP2000_ID_ECU_PARTNUM,
)
